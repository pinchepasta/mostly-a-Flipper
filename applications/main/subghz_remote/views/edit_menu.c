        ...
        SubRemViewEditMenuModel * model,
        {
            ...
            if(button != ButtonOK && !furi_string_empty(path)) {
                furi_string_cat_printf(
                    model->file_path,
                    " (Btn. %s)",
                    subrem_custom_button_display_text(button));
            }
...
void subrem_view_edit_menu_draw(Canvas* canvas, SubRemViewEditMenuModel* model) {
    ...
    case SubRemSubKeyNameExtra:
        canvas_draw_str(canvas, 3, FRAME_HEIGHT - 2, "EXTRA");
        break;

    case SubRemSubKeyName7:
        canvas_draw_str(canvas, 3, FRAME_HEIGHT - 2, "7");
        break;

    case SubRemSubKeyName8:
        canvas_draw_str(canvas, 3, FRAME_HEIGHT - 2, "8");
        break;

    case SubRemSubKeyName9:
        canvas_draw_str(canvas, 3, FRAME_HEIGHT - 2, "9");
        break;
    ...
    if(model->chosen != (SubRemSubKeyNameMaxCount - 1)) {
