...
bool ws_radio_device_loader_is_connect_external(const char* name) {
...
const SubGhzDevice* ws_radio_device_loader_set(
    ...
    if(radio_device_type == SubGhzRadioDeviceTypeExternalCC1101 &&
       ws_radio_device_loader_is_connect_external(SUBGHZ_DEVICE_CC1101_EXT_NAME)) {
        radio_device_loader_power_on();
        ...
        ws_radio_device_loader_end(current_radio_device);
        radio_device = subghz_devices_get_by_name(SUBGHZ_DEVICE_CC1101_INT_NAME);
    }
