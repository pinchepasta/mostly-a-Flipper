...
static const char* map_file_labels[SubRemSubKeyNameMaxCount][3] = {
    ...
    [SubRemSubKeyNameExtra] = {"EXTRA", "EXTRALABEL", "EXTRABUTTON"},
    [SubRemSubKeyName7] = {"BTN7", "BTN7LABEL", "BTN7BUTTON"},
    [SubRemSubKeyName8] = {"BTN8", "BTN8LABEL", "BTN8BUTTON"},
    [SubRemSubKeyName9] = {"BTN9", "BTN9LABEL", "BTN9BUTTON"},
};
