...
#define NRF24_JAM_CFG_VERSION (7) /* v7: add a broad-spectrum sweep toggle */
...
static void nrf24_jam_config_defaults(void) {
    ...
    nrf24_jam_config_fill(&g_settings.wifi, Nrf24StrategyCw, 0, 60);
    nrf24_jam_config_fill(&g_settings.activity, Nrf24StrategyTurbo, 1, 60);
}
...
static void nrf24_jam_config_clamp(Nrf24JamConfig* c) {
    ...
    if(c->wide_spectrum > 1) c->wide_spectrum = 0;
