...
uint16_t nrf24_jam_preset_default_dwell_us(Nrf24JamPreset preset) {
    switch(preset) {
    case Nrf24JamPresetBleAdv: /* Parked carrier on the 3 adv channels */
        return 220;
    case Nrf24JamPresetWifi: /* Short, dense bursts on the WiFi band */
        return 50;
    case Nrf24JamPresetBle: /* Flood data channels without wasting time */
        return 70;
    case Nrf24JamPresetBluetooth: /* FHSS benefits from a fast, moving carrier */
        return 40;
    ...
    case Nrf24JamPresetDrone:
    default:
        return 35; /* fast sweep across many channels */
    }
}

uint8_t nrf24_jam_preset_default_strategy(Nrf24JamPreset preset) {
    switch(preset) {
    case Nrf24JamPresetBleAdv: /* BLE advertising is best hit with a parked CW carrier */
        return Nrf24StrategyCw;
    case Nrf24JamPresetWifi:
    case Nrf24JamPresetBle:
    case Nrf24JamPresetZigbee:
        /* Channel-specific protocols respond well to flood/turbo collisions */
    ...
    case Nrf24JamPresetUsb:
    case Nrf24JamPresetVideo:
        /* FHSS and analog-style links are disrupted best with a steady carrier */
        return Nrf24StrategyCw;
    case Nrf24JamPresetFull:
    default:
        return Nrf24StrategyTurbo;
...
uint8_t nrf24_jam_preset_default_hop(Nrf24JamPreset preset) {
    ...
    case Nrf24JamPresetZigbee:
    case Nrf24JamPresetFull:
        return 0; /* sequential for focused channel targeting */
    case Nrf24JamPresetBle:
    case Nrf24JamPresetBluetooth:
    case Nrf24JamPresetDrone:
    default:
        return 1; /* random hop for wider FHSS or multi-channel targets */
    }
}
