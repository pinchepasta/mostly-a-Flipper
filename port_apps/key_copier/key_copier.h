...
/* Recalibrated for the M5Stack Cardputer: the 128 px Flipper canvas is scaled to
 * the full 240 px width (~0.99") of the 1.14" 240x135 panel, so each canvas pixel
 * spans ~0.99/128 in (vs 0.00978 on the Flipper's 1.4" screen). Tune on hardware
 * against a known reference. */
#define INCHES_PER_PX             0.00776
